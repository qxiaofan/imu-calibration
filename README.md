...
本工程forked from [imu_tk](https://github.com/Kyle-ak/imu_tk), 详细介绍如下。
...
```
and follow this [guide](https://github.com/ceres-solver/ceres-solver) to install Ceres Solver. 如有不会的，请自行百度。
